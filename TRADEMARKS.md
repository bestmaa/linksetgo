...
The source code is licensed under AGPL-3.0-or-later. That license does not grant
permission to use project names, logos, product identities, domain names, or
