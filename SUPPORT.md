...
customer URLs, database dumps, raw logs containing personal data, or vulnerability
details.

For installation and operations, start with:

- [Self-hosting](./docs/self-hosting.md)
- [Backup and restore](./docs/backups.md)
- [React Native integration](./docs/guides/REACT_NATIVE.md)
- [Tenant migration](./docs/operations/TENANT_MIGRATION.md)
